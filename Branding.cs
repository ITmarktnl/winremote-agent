...
/// "WinRemote-jouwbedrijf.exe": het deel na het streepje is de tenant-slug. Later haalt de agent de
/// bijbehorende naam, kleur en logo op van winremote.nl; nu geldt de standaard-huisstijl.
/// </summary>
public sealed record Branding(string Slug, string Naam, string Ondertitel, Color Kleur)
{
	public const string SignaalBasis = "https://signaal.winremote.nl";
	public const string SignaalWs = "wss://signaal.winremote.nl";

	public static Branding Standaard { get; } =
		new("demo", "WinRemote", "Hulp op afstand", Color.FromArgb(0xC8, 0x10, 0x2E));

	/// <summary>Leidt de tenant-slug af uit de bestandsnaam van de .exe.</summary>
	public static Branding UitBestandsnaam()
	{
		var naam = Path.GetFileNameWithoutExtension(Environment.ProcessPath ?? "WinRemote");
